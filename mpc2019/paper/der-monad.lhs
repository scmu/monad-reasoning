...
\institute{Institute of Information Science, Academia Sinica
    \and Department of Computer Science, KU Leuven
    }
% TODO e-mail addresses: "@" symbol gets replaced by lhs2TeX, not sure
% how to fix except through some hack in the build script.
