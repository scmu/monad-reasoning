...
\begin{itemize}
	...
	\item We illustrate the simulations and resulting optimizations using the n-queens puzzle as a running example throughout
		  all sections.
	\item We prove all simulations correct using equational reasoning techniques (\Cref{app:local-global}, \Cref{app:universality-nondeterminism} and \Cref{app:runnd-hnd}).
\end{itemize}
