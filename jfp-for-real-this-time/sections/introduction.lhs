...
Knowledge of the trade-off between ``high level'' and ``low level'' styles of programming is almost as old as the field of computer science itself.
...
Although they are rarely described in this way, we can spot a similar pattern with effects: some effects can be described as ``lower level'' than other effects.
