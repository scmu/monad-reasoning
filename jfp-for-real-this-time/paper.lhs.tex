...
\begin{abstract}
  ...
  from the optimizations enabled by low-level effects.
  %
  ...
  backtracking. Next, we eliminate nondeterminism altogether in favor of a
  ...
  % %
  % Moreover, we demonstrate possible optimizations such as efficient
