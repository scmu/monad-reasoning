...
For a more rigorous treatment, we present a more precise separation between syntax and semantics,
and showed that a program written for local state works for the global state scenario if we replace all occurrences of |put| by |putR|.
