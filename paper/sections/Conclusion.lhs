...
For a more rigorous treatment, we enforce a more precise separation between syntax and semantics and, as a side contribution of this pearl, propose a collection of \emph{global state laws} which the semantics should satisfy.
